---
layout: default
title: What is a Sprint in Scrum? The definitive guide.
page_title: Sprints
has_children: false
...
A framework that came into existence in the early 1990s and has got nearly every software team adopting it. Today, any team that’s serious about its business follows scrum and runs sprints within their team.
...
## But first, let’s get the basics of Scrum out of the way
{: .fs-9 }
...
According to the [scrum guide](https://www.scrumguides.org/docs/scrumguide/v2017/2017-Scrum-Guide-US.pdf), scrum is lightweight, simple to understand, but difficult to master.
...
To run an effective scrum sprint, it isn’t enough to get your team together and start checking off [user stories]({{ site.url }}{{ site.baseurl }}{% link agile/user-stories.md %}) and tasks. You need to lay the ground-work and set the stage. That way, when your team begins executing them, they’ll have all the context they need to deliver quality software on time.
...
Product backlog refinement is all about making sure the items at the top of the backlog are ready for the next sprint. This includes, making sure the user stories are up-to-date, adding [acceptance criteria]({{ site.url }}{{ site.baseurl }}{% link agile/user-stories-acceptance-criteria.md %}) as descriptions to user stories, removing duplicate items, and adjusting priorities based on customer needs.
...
At the end of the [sprint planning meeting]({{ site.url }}{{ site.baseurl }}{% link agile/scrum-sprint-planning-meeting.md %}), the team should walk away with two things: a sprint goal and a sprint backlog, both of which are decided collaboratively by the entire team.
...
![categorize tasks into three during estimation](/agile/assets/uploads/estimation.png)
<div class="caption">
<small>Work towards moving all tasks to "Known Tasks" category</small>
</div>

Once your development team has estimated and added [story points]({{ site.url }}{{ site.baseurl }}{% link agile/scrum-story-points.md %}) to all the stories, it’s time to come up with a sprint goal and a sprint backlog that your team will work towards achieving. This depends on the sprint duration and the estimates your team added to each of the user stories. Ideally, a sprint duration is a month or less. However, most teams decide to run a two-week sprint to stay nimble.
...
1. The development team take turns to answer three questions:
...
2. The scrum master acts as the facilitator during the meeting, helps remove roadblocks, and ensures the daily scrum meeting is complete in 15 minutes or less.
3. The product owner plays no part in the daily scrum meeting, but attending it gives them the ground-level context of what’s happening.

From an individual standpoint, it’s essential to walk into the day’s [daily scrum]({{ site.url }}{{ site.baseurl }}{% link agile/scrum-daily-standup-meeting.md %}) knowing what you’re going to say. It helps keep the team motivated and keeps the daily scrum meeting going past the 15 minute period. 

At [Zepel](https://zepel.io/?utm_source=agilelibrary&utm_medium=text&utm_campaign=scrumsprint), individuals use Zepel's scrum boards along with filters to keep on top of the features they’re working on. A filter that can be used to help every individual prepare for the daily scrum is selecting your name under the “Assigned to” section inside the filters. When this filter is used, you can see all the items that are assigned to you.

![Using multiple scrum boards during a sprint in Zepel](/agile/assets/uploads/scrum-board-filters-daily-scrum-meeting.gif)
<div class="caption">
<small>Using scrum boards with filters during daily scrum stand-up meeting</small>
</div>
...
This where a tool like [Zepel](https://zepel.io/?utm_source=agilelibrary&utm_medium=text&utm_campaign=scrumsprint) can come in to help you keep track of your team’s progress. Zepel deeply integrates with the tools your development team uses every day — like GitHub, Bitbucket, and GitLab. This enables them to update progress right from their code editor and allows you to get all the updates in real-time.

![Git integration with Zepel](/agile/assets/uploads/zepel-pull-request-opened.png)
<div class="caption">
<small>Track updates as they make progress in their code base</small>
</div>
...
This, however, doesn’t mean the purpose of a [sprint review meeting]({{ site.url }}{{ site.baseurl }}{% link agile/scrum-sprint-review-meeting.md %}) is to present your work. It is to collect feedback so you can make improvements in future sprints. That’s why, for whatever reasons your team may want to skip the sprint review meeting, you shouldn’t. 
...
- Are you spending more time managing the tool than planning your feature?
- Will you be able to add a new task/user story/enhancement/bug at the speed of thought instead of waiting for multiple page loads?
...
<div class="highlight-card">
    <div class="highlight-container">
        <a href="https://zepel.io/features/plan-features/?utm_source=agilelibrary&utm_medium=mid-cta&utm_campaign=scrumsprint" target="_blank">
        <p class="highlight-card-title">Effortlessly plan every step of your feature with Zepel  →</p>
        </a>    
    </div>
</div>
</div>
...
![Multiple boards to accommodate multiple teams](/agile/assets/uploads/zepel-boards.png)
<div class="caption">
<small>Multiple boards to seamlessly collaborate across functions</small>
</div>
<br>
...
![Track progress of the feature in Zepel](/agile/assets/uploads/zepel-feature-tracking.png)
<div class="caption">
<small>Zoom out and track the impact your Sprint has on the progress of the feature accross teams</small>
</div>
<br>
...
<div class="highlight-card">
    <div class="highlight-container">
        <a href="https://zepel.io/features/feature-tracking/?utm_source=agilelibrary&utm_medium=mid-cta&utm_campaign=scrumsprint" target="_blank">
        <p class="highlight-card-title">Get a complete picture of the progress at multiple levels with Zepel  →</p>
        </a>    
    </div>
</div>
</div>
...
![Automate Status Updates Based on Git Workflow in Zepel](/agile/assets/uploads/zepel-git-workflow-automation.png)
<div class="caption">
<small>Automate status updates based on Git workflow</small>
</div>
<br>
...
- Ability to set up Git Workflow Automations to automatically update statuses based on developer workflow
...
<div class="highlight-card">
    <div class="highlight-container">
        <a href="https://zepel.io/features/integrations/?utm_source=agilelibrary&utm_medium=mid-cta&utm_campaign=scrumsprint" target="_blank">
        <p class="highlight-card-title">Streamline your entire workflow with integrations  →</p>
        </a>    
    </div>
</div>
</div>
...
## Best scrum tool to run sprints
{: .fs-9 }

It’d be unfair to leave you without also giving you a sense of the best scrum tool for software development teams in the market today.

Zepel is the project management tool built for software product teams to collaborate across teams and is effortless to use. It lets you track progress on multiple levels in real-time — user story, team, sprint, or at a feature level. 

Since Zepel is built for software product teams, you are also provided with tight GitHub, GitLab, and Bitbucket integrations along with public APIs to help streamline your development workflow.

### What Customers Say About Zepel
{: .fs-7 .no_toc }

![Automate Status Updates Based on Git Workflow in Zepel](/agile/assets/uploads/zepel-customer-review.png)
<div class="caption">
<small>Customer review of Zepel</small>
</div>

### Zepel is a High Performer and the Top Ranked solution According to Customers
{: .fs-7 .no_toc }

<div class="badges">
  <img src="/agile/assets/uploads/zepel-g2-winter-2020.png" alt="Zepel G2 Crowd Badge for Winter 2020" class="badge-img"/>
  <img src="/agile/assets/uploads/zepel-g2-spring-2020.png" alt="Zepel G2 Crowd Badge for Spring 2020" class="badge-img"/>
  <img src="/agile/assets/uploads/zepel-crozdesk-top-ranked-2020.png" alt="Zepel Voted Top Ranked Solution for 2020" width="50%" height="50%" class="badge-img"/>
  <br><br>
  <div class="caption">
    <small>Zepel is loved by customers</small>
  </div>
 </div> 
...
<div class="cta">
    ...
    <a href="https://zepel.io/solutions/scrum/?open_modal=true&utm_source=agilelibrary&utm_medium=bottom-cta&utm_campaign=scrumsprint" class="cta-button">TRY ZEPEL FOR FREE</a>
</div>

<a href="https://zepel.io/solutions/scrum/?open_modal=true&utm_source=agilelibrary&utm_medium=bottom-cta&utm_campaign=scrumsprint" class="cta-image"><img src="/agile/assets/uploads/scrum-sprint-cta.png" alt="sprint planning template button"/></a>
